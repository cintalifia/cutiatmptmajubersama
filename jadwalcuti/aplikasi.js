...
(function($) {
	...
	$(document).ready(function(e) {
		...
		var nik = 0;
                var page = 0;
             //   var url = "jadwalcuti.data.php"
                pagenya = this.pagenya
                //pagenya = 7;
		var main = "jadwalcuti.data.php";
		var maincari = "jadwalcuti.datacari.php";
		//var main = "jadwalcuti.data.php?pagination=true&page=" + pagenya;
		// tampilkan data mahasiswa dari berkas mahasiswa.data.php 
		// ke dalam <div id="data-mahasiswa"></div>
		$("#data-jadwalcuti").load(main);
		$("#caridata-jadwalcuti").load(maincari);
		// ketika tombol ubah/tambah di tekan
		$('.ubah, .tambah').live("click", function(){
			
			var url = "jadwalcuti.form.php";
			// ambil nilai id dari tombol ubah
			nik = this.id;
			if(nik != 0) {
				// ubah judul modal dialog
				$("#myModalLabel").html("Ubah Data jadwalcuti");
			} else {
				// saran dari mas hangs 
				$("#myModalLabel").html("Tambah Data jadwalcuti");
			}
...
// tampilkan mahasiswa.form.php ke dalam <div class="modal-body"></div>
		...
		$("#simpan-jadwalcuti").bind("click", function(event) {
			var url = "jadwalcuti.input.php";
