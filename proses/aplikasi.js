...
(function($) {
	...
	$(document).ready(function(e) {
		...
		var nik = 0;
                var page = 0;
             //   var url = "proses.data.php"
                pagenya = this.pagenya
                //pagenya = 7;
		var main = "proses.data.php";
		var maincari = "proses.datacari.php";
		//var main = "proses.data.php?pagination=true&page=" + pagenya;
		// tampilkan data mahasiswa dari berkas mahasiswa.data.php 
		// ke dalam <div id="data-mahasiswa"></div>
		$("#data-proses").load(main);
		$("#caridata-proses").load(maincari);
		// ketika tombol ubah/tambah di tekan
		$('.ubah, .tambah').live("click", function(){
			
			var url = "proses.form.php";
			// ambil nilai id dari tombol ubah
			nik = this.id;
		
				$("#myModalLabel").html("Proses Pengajuan Cuti");
...
// tampilkan mahasiswa.form.php ke dalam <div class="modal-body"></div>
		...
		$("#simpan-proses").bind("click", function(event) {
			var url = "proses.input.php";
			...
			$.post(url, {nik: v_nik, id: v_idpengajuan } ,function() {
//$("#myModalLabel").html("Tambah Data proses");
