...
(function($) {
	...
	$(document).ready(function(e) {
		...
		var nik = 0;
                var page = 0;
             //   var url = "sisacuti.data.php"
                pagenya = this.pagenya
                //pagenya = 7;
		var main = "sisacuti.data.php";
		var maincari = "sisacuti.datacari.php";
		//var main = "sisacuti.data.php?pagination=true&page=" + pagenya;
		// tampilkan data mahasiswa dari berkas mahasiswa.data.php 
		// ke dalam <div id="data-mahasiswa"></div>
		$("#data-sisacuti").load(main);
		$("#caridata-sisacuti").load(maincari);
		// ketika tombol ubah/tambah di tekan
		$('.ubah, .tambah').live("click", function(){
			
			var url = "sisacuti.form.php";
			// ambil nilai id dari tombol ubah
			nik = this.id;
			if(nik != 0) {
				// ubah judul modal dialog
				$("#myModalLabel").html("Ubah Data sisacuti");
			} else {
				// saran dari mas hangs 
				$("#myModalLabel").html("Tambah Data sisacuti");
			}
...
// tampilkan mahasiswa.form.php ke dalam <div class="modal-body"></div>
		...
		$("#simpan-sisacuti").bind("click", function(event) {
			var url = "sisacuti.input.php";
